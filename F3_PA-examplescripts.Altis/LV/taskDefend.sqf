...
_redMenArray = ["O_Soldier_A_F","O_soldier_AR_F","O_medic_F","O_engineer_F","O_soldier_exp_F","O_Soldier_GL_F","O_soldier_M_F","O_soldier_AA_F","O_soldier_AT_F","O_officer_F","O_soldier_repair_F","O_G_Soldier_F","O_soldier_LAT_F","O_Soldier_lite_F","O_Soldier_SL_F","O_Soldier_TL_F","O_soldier_AAR_F","O_soldier_AAA_F","O_soldier_AAT_F"];
...
sleep 3;
{
	...
	if (_x == leader (group _x)) then{
		[_x,_x,_radius,2,true] call CBA_fnc_taskDefend;
...
if(!isNil("_grpId"))then{
	...
	call compile format["LVgroup%1CI = ['taskDefend',%2]",_grpId,_thisArray];
};
